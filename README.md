...
Duration: 15th may  to 15th Jun 

Overview of the Project
#output
<img width="1246" height="835" alt="Image" src="https://github.com/user-attachments/assets/354ea000-3743-443f-a9f5-c0b07545514c" />
<img width="1247" height="837" alt="Image" src="https://github.com/user-attachments/assets/372e890f-73e0-40c5-8c3a-ac27a5eee01c" />
...
Code Explanation
1.	API Integration:
o	requests.get() is used to fetch weather data.
o	The API key and city name are passed as parameters.
2.	Data Parsing:
o	The JSON response is parsed to extract dates, temperatures, and humidity values.
3.	Visualization:
o	Line plots are created for temperature and humidity trends using Matplotlib and Seaborn.
________________________________________
Contact
